...
class facial_recognition():
    ...
    def get_photo(self):
        ...
        face_cascade = cv2.CascadeClassifier('facial_recognition/haarcascade_frontalface_default.xml')
    ...
    def encode_photo(self):
        ...
        for encoding in encodings:
            self.add_encoding(encoding, self.user)
            print(f'user: {self.user}, encoding: {encoding}')
